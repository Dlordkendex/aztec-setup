...
services:
  aztec:
    ...
    environment:
      ...
      VALIDATOR_ATTESTATIONS_POLLING_INTERVAL_MS: "100"
      VALIDATOR_REEXECUTE: "false"
      SEQ_TX_POLLING_INTERVAL_MS: "250"
      L1_READER_VIEM_POLLING_INTERVAL_MS: "500"
      SEQ_PUBLISH_RETRY_INTERVAL_MS: "500"
      L1_GAS_LIMIT_BUFFER_PERCENTAGE: "40"
      L1_GAS_PRICE_MAX: "1000"
      L1_BLOB_FEE_PER_GAS_MAX: "3000"
      L1_PRIORITY_FEE_BUMP_PERCENTAGE: "40"
      L1_PRIORITY_FEE_RETRY_BUMP_PERCENTAGE: "70"
      L1_TX_MONITOR_MAX_ATTEMPTS: "6"
      L1_TX_MONITOR_CHECK_INTERVAL_MS: "500"
      L1_TX_MONITOR_TX_TIMEOUT_MS: "150000"
      ETHEREUM_SLOT_DURATION: "10"
      AZTEC_SLOT_DURATION: "20"
      AZTEC_EPOCH_DURATION: "14"
